...
const AddAction = () => {
  dialogTitle.value = t('tableDemo.buy')
...
const action = (row: TableData, type: string) => {
  dialogTitle.value = t(type === 'buy' ? 'tableDemo.buy' : 'tableDemo.detail')
...
<template>
  <ContentWrap>
    ...
    <div class="mb-10px">
      <BaseButton type="primary" @click="AddAction">{{ t('tableDemo.buy') }}</BaseButton>
